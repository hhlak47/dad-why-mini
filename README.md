...
> 🚀 **第一次拿到这个仓库？** 请先看 **[复刻指南.md](复刻指南.md)** —— 从装软件、换 AppID、部署云函数、配密钥到声音克隆，一步步照做即可，无需懂编程。
>
> 🛠 **想做成你自己的定制版？** 仓库附带 Skill 构建指南（`.trae/skills/kids-ai-voice-app/`），用 TRAE 等 AI 工具可照着生成你自己的小程序。
